...
#include "rendertesthull.h"
#include "types.h"

namespace wavevis2 {


RenderTestHull::RenderTestHull(bf::path scratch, int scale) :
  scale_(scale)
{
  
}

RenderTestHull::~RenderTestHull()
{

}

void RenderTestHull::renderStream(timeid_t t1, timeid_t t2, int pixels)
{
  /* Must be thread-safe!
   */
...
void RenderTestHull::reset() {
  // FIXME

}


void RenderTestHull::newDataWindow(const elements::datawindow_t<pWaveBuffer_t> & datawindow ) 
{
