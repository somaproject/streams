...
WaveVisTriggerRenderer::WaveVisTriggerRenderer(std::vector<GLWavePoint_t> * pSamples):
  pSamples_(pSamples),
  emptyTriggerList_(), 
...
WaveVisTriggerRenderer::~WaveVisTriggerRenderer()
{

}

void WaveVisTriggerRenderer::newSample()
{

}

void WaveVisTriggerRenderer::drawTriggers(float tbefore, float tafter, float timepoint)
{
...
sigc::signal<void> & WaveVisTriggerRenderer::invWaveSignal()
{
  return invWaveSignal_;
}

void WaveVisTriggerRenderer::updateTriggers(bool reset)
{
  if (reset)
    {
...
void WaveVisTriggerRenderer::setTriggerSource(const QueueView<float> & tqv)
{
