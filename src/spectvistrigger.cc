...
SpectVisTrigger::SpectVisTrigger(SpectBlockpVector_t * pSpectBlocks) :
...
SpectVisTrigger::~SpectVisTrigger()
{
...
bool SpectVisTrigger::triggerFunc(GLWavePoint_t p1,  GLWavePoint_t p2)
{
  // p1 comes before p2:
...
void SpectVisTrigger::newSample()
{
...
void SpectVisTrigger::enableTrigger(bool state)
{
...
void SpectVisTrigger::setTriggerValue(float val)
{
  triggerLevel_ = val;
}

QueueView<float> SpectVisTrigger::getTriggerQueueView()
{
  return QueueView<float>(triggers_); 
}

updateTriggersSignal_t & SpectVisTrigger::updateTriggersSignal()
{
